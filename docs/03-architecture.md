...
- the **`MCL` binding** — electrical profile, framing, request correlation, flow control, bit rate, turnaround, termination, fail-safe — and whether `MCL` may be cascaded over a Hub-to-Hub link port;

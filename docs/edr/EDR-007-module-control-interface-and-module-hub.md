...
- [Interfaces and Versioning](https://github.com/auriora-org/auriora-engineering-standard/blob/v0.7.1/docs/05-interfaces-and-versioning.md#aes-sync-002-point-to-point-links-and-active-fan-out) — `AES-SYNC-002` amended for composite devices, static pre-ARM configuration, passive observation and the SYNC Source role.
